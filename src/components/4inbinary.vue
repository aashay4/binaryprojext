  ...
  <div>
    ...
    <div class="w3-row w3-padding-64">
        <div class="w3-twothird w3-container">
          <h1 class="w3-text-teal">Convert number 4 in binary</h1>
<div class="w3-hover-shadow w3-panel w3-leftbar w3-light-grey" style="height: 376px;"><br>
          ...
          <p>The conversion of 4 in binary is : 100</p>
        </div><br>
...
export default {
  ...
  metaInfo: {
     title: 'How to Write 4 in binary',
     meta: [
       {name: 'viewport', content: 'width=device-width, initial-scale=1'},
       {name: 'description', content: ''}
     ],
     link: [
    {rel: 'canonical', href: 'https://binarytotext.net/how-to-write-4-in-binary/'}
  ]
   },
