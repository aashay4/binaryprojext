    ...
    <div class="w3-main" style="margin-left:250px">
      <div class="w3-row w3-padding-64">
        <div class="w3-twothird w3-container">
          ...
          <button v-on:click="bintohex()" style="width: 32%">Binary to Hexadecimal</button>
          <button v-on:click="hextobin()" style="width: 32%">Hexadecimal to binary</button>
...
export default {
  ...
  methods: {
    bintohex() {
      ...
      var bintohex = parseInt(this.text_value, 2).toString(16);
                    this.ans = bintohex;
            },
    hextobin() {
      this.aaa = parseInt(this.text_value)
    var dectobin = (parseInt(this.aaa, 16).toString(2));
    this.ans = dectobin;
     },
   reset() {
     this.ans = '',
